 ...
 * generated in the network package. 
...
public class ObjectFactory {
    ...
    private final static QName _Network_QNAME = new QName("urn:network", "network");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: network
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "urn:network", name = "network")
